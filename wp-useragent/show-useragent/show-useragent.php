...
/* 浏览器 */
$CID_image_url = WP_PLUGIN_URL."/wp-useragent/show-useragent/browsers/";
...
function CID_friendly_string($browser_name = '', $browser_code = '', $browser_ver = '', $os_name = '', $os_code = '', $os_ver = '', $pda_name= '', $pda_code = '', $pda_ver = '') {
	...
	$output = str_replace("%IMAGE_BASE%", WP_PLUGIN_URL."/wp-useragent/show-useragent/browsers", $output);
