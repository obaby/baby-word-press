						...
						<div class="inside">
							...
							<table class="form-table">
								<tbody>
									...
									<tr>
										<th><?php _e('Show User Country Flag', 'wp-useragent'); ?>:</th>
										<td>
											<select id="wpua_show_country_flag" name="wpua_show_country_flag">
												<option value="true" <?php if ($wpua_show_country_flag === 'true') echo 'selected="selected"'; ?>><?php _e('Yes', 'wp-useragent'); ?></option>
												<option value="false" <?php if ($wpua_show_country_flag !== 'true') echo 'selected="selected"'; ?>><?php _e('No', 'wp-useragent'); ?></option>
											</select>
										</td>
									</tr>
									<tr>
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<p>
								...
								<a href="https://wordpress.org/plugins/wp-useragent/changelog/" target="_blank" class="button"><?php _e('Changelog', 'wp-useragent'); ?></a>
								<a href="https://translate.wordpress.org/projects/wp-plugins/wp-useragent" target="_blank" class="button"><?php _e('Translate', 'wp-useragent'); ?></a>
								<a href="http://h4ck.org.cn/2022/08/wordpress-%E8%AF%84%E8%AE%BA%E6%98%BE%E7%A4%BAip%E5%BD%92%E5%B1%9E%E5%9C%B0/" target="_blank" class="button"><?php _e('问题反馈', 'wp-useragent'); ?></a>
							</p>
		...
		;(function($){
			...
			$.fn.wpUserAgent = function() {
				...
				var wpua_icon_net_16 = "",
					...
					wpua_country_ico = "",
					wpua_ip_address_ico = "",
				...
				function preview() {
					...
					var wpua_ua_string = ($wpua_show_full_ua.val() === 'true') ? 'Opera/9.80 (X11; Ubuntu/9.10 x86_64; U; en) Presto/2.2.15 Version/10.00' : '',
						...
						wpua_country_text ='山东省 青岛市联通',
					wpua_ip_text ='114.114.*.*',
					...
					if ($wpua_show_text_icons.val() !== 'text') {
						if ($wpua_icon_size.val() === '16') {
							wpua_content = wpua_text_using + "<img src='data:image/png;base64," + wpua_icon_net_16 + "' alt='Browser:' style='border:0px;vertical-align:middle;' />" + wpua_browser + wpua_text_on + " <img src='data:image/png;base64," + wpua_icon_os_16 + "' alt='System:' style='border:0px;vertical-align:middle;' />" + wpua_system + "<img src='data:image/png;base64," + wpua_country_ico + "' alt='country:' style='border:0px;vertical-align:middle;' /> " + wpua_country_text + "<img src='data:image/png;base64," + wpua_ip_address_ico + "' alt='ip:' style='border:0px;vertical-align:middle;' />" + wpua_ip_text;
						} else {
							wpua_content = wpua_text_using + "<img src='data:image/png;base64," + wpua_icon_net_24 + "' alt='Browser:' style='border:0px;vertical-align:middle;' />" + wpua_browser + wpua_text_on + " <img src='data:image/png;base64," + wpua_icon_os_24 + "' alt='System:' style='border:0px;vertical-align:middle;' />" + wpua_system + "<img src='data:image/png;base64," + wpua_country_ico + "' alt='country:' style='border:0px;vertical-align:middle;' /> " + wpua_country_text + "<img src='data:image/png;base64," + wpua_ip_address_ico + "' alt='ip:' style='border:0px;vertical-align:middle;' />" + wpua_ip_text;
						}
					} else {
